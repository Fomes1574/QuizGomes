...
INSERT OR IGNORE INTO themes (
  ...
  ('theme-games-general', 'cat-games', 'games-em-geral', 'Games em Geral', 'Fixture sintética para validar a experiência de desenvolvimento.', 'ACTIVE', 'OFFICIAL', 'questions-01', 10),
