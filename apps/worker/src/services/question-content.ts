/**
 * Chave de conteúdo de uma pergunta: mesmo hash para o mesmo tema+dificuldade
 * +enunciado+alternativas, normalizado e minúsculo, para detectar duplicata
 * tanto no import em lote quanto na criação/edição individual.
 */
...
export function questionPoolId(themeId: string, difficulty: string): string {
